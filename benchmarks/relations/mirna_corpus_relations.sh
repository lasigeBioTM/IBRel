...
python src/main.py train_relations --goldstd miRNACorpus_train --log $LOGLEVEL --models goldstandard  --etype1 mirna --etype2 protein --kernel jsre
python src/main.py test_relations --goldstd miRNACorpus_test --log $LOGLEVEL --models goldstandard --etype1 mirna --etype2 protein --kernel jsre -o pickle results/mirnatrain_on_mirnatest_mirnaprotein_jsre
...
python src/main.py train_relations --goldstd miRNACorpus_train --log $LOGLEVEL --models goldstandard  --etype1 mirna --etype2 protein --kernel svmtk
python src/main.py test_relations --goldstd miRNACorpus_test --log $LOGLEVEL --models goldstandard --etype1 mirna --etype2 protein --kernel svmtk -o pickle results/mirnatrain_on_mirnatest_mirnaprotein_svmtk
