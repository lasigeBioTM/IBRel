...
python src/evaluate.py evaluate miRNACorpus_test --results results/mirnatrain_on_mirnatest_mirnaprotein --models goldstandard --pairtype Specific_miRNAs-Genes/Proteins --log $LOGLEVEL
...
# python src/evaluate.py evaluate miRNACorpus_test --results results/mirnatrain_on_mirnatest_mirnaprotein_rules --models goldstandard --pairtype Specific_miRNAs-Genes/Proteins --log $LOGLEVEL
