...
#python src/crossvalidation.py --goldstd genia_sample --log $LOGLEVEL --entitytype protein --models results/genia_cv_protein

python src/main.py annotate --goldstd genia_sample --log $LOGLEVEL --entitytype dna
python src/crossvalidation.py --goldstd genia_sample --log $LOGLEVEL --entitytype dna --models results/genia_cv_dna