...
#python src/main.py load_corpus --goldstd miRTex_dev --log DEBUG --entitytype mirna
#python src/main.py load_corpus --goldstd miRTex_test --log DEBUG --entitytype mirna
