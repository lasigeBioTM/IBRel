...
python src/main.py train --goldstd jnlpba_train --log $LOGLEVEL --entitytype DNA --models models/jnlpba_train_dna --crf crfsuite
python src/main.py test --goldstd jnlpba_test --log $LOGLEVEL --entitytype DNA --models models/jnlpba_train_dna -o pickle results/jnlpbatrain_on_jnlpbatest_dna --crf crfsuite
python src/evaluate.py evaluate jnlpba_test --results results/jnlpbatrain_on_jnlpbatest_dna --models models/jnlpba_train_dna --entitytype DNA
